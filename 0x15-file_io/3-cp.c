...
char *create_buffer_allocator(char *file);
void close_file(int fd);

/**
 * create_buffer_allocator - Allocates 1024 bytes for a buffer.
...
/**
 * main_copy - Copies the contents of a file to another file.
